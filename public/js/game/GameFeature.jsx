...
const PERAYAAN_HASIL={
  menang:{src:"/js/game/yesus_bersorak.gif",alt:"Bersorak untuk kemenanganmu",kutipan:`"Bersorak-sorailah bagi TUHAN, hai bumi!" — Mazmur 100:1`},
  seri:{src:"/js/game/yesus_seri.gif",alt:"Menemanimu dengan sukacita",kutipan:`"Sebab di mana dua atau tiga orang berkumpul dalam nama-Ku, di situ Aku ada di tengah-tengah mereka." — Matius 18:20`},
  kalah:{src:"/js/game/yesus_kalah.gif",alt:"Menguatkanmu untuk mencoba lagi",kutipan:`"Sebab tujuh kali orang benar jatuh, namun ia bangun kembali." — Amsal 24:16`},
};
function PerayaanHasil({status}){
  ...
  return(
    <div className="gf-pop"style={{marginTop:4,marginBottom:6}}>
      <img src={cfg.src}alt={cfg.alt}style={{width:120,aspectRatio:"32/35",imageRendering:"pixelated",margin:"0 auto",display:"block"}}onError={e=>{e.target.style.display="none";}}/>
